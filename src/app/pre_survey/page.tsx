    ...
    return (
        <div className="flex flex-col items-center justify-between p-44 space-y-5 space-x-4">
            <div className="flex  flex-col space-y-4 text-xl">
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;แบบสอบถามฉบับนี้มีวัตถุประสงค์เพื่อใช้ในการคัดกรองสุขภาพเบื้องต้น สำหรับประกอบการดูแล
                    นักศึกษาที่เข้าร่วมกิจกรรมฯ และวางแผนเตรียมพร้อมในการปฏิบัติงานของมหาวิทยาลัยเชียงใหม่ในการจัด
                    กิจกรรมประเพณีรับน้องขึ้นดอย ปี 2566 ซึ่งการเก็บข้อมูลมีความจำเป็นต้องเข้าถึงข้อมูลส่วนบุคคล
                    เพื่อตรวจสอบความถูกต้องและส่งต่อไปยังศูนย์สุขภาพ มช. (คลินิกไผ่ล้อม) เพื่อรับการตรวจคัดกรองสุขภาพโดย
                    ละเอียด และผู้จัดกิจกรรมของคณะที่นักศึกษาสังกัด จึงขอความกรุณานักศึกษาคัดกรองสุขภาพด้วยความเป็นจริง
                    สำหรับการนำเสนอข้อมูลสุขภาพจะถูกนำเสนอในภาพรวมเท่านั้น
                </p>
                <p>
